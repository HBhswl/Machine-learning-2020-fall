...
X = pd.read_csv('all_train_place.csv', low_memory=False)
X_test = pd.read_csv('all_test_place.csv', low_memory=False)
...
# ### Model Parameters
categorical_features = ["DayOfWeek", "PdDistrict", "Intersection", "Special Time", "XYcluster", "TP"]
...
sub_df.to_csv('lgb_all_place.csv', index=False)
