...
class SklearnHelper(object):
    ...
    def train(self, x_train, y_train, eval_sets):
        self.clf.fit(x_train, y_train, verbose=True, eval_set=eval_sets, early_stopping_rounds=100)
...
def get_oof(clf, x_train, y_train, x_test):
    ...
    for train_index, test_index in skf.split(x_train, y_train):
        ...
        clf.train(x_tr, y_tr, eval_sets=(x_te, y_te))
...
lgb_model = SklearnHelper(clf=CatBoostClassifier, seed=SEED, params=lgb_params)
