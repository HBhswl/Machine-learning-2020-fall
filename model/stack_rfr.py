...
class SklearnHelper(object):
    def __init__(self, clf, seed=0, params=None):
        ...
        self.clf = clf(n_estimators=500, criterion='gini', max_depth=6, n_jobs=-1)
...
# lgb_model = SklearnHelper(clf=GaussianNB, seed=SEED, params=lgb_params)
# lgb_model = SklearnHelper(clf=LogisticRegression, seed=SEED, params=lgb_params)
# lgb_model = SklearnHelper(clf=KNeighborsClassifier, seed=SEED, params=lgb_params)
lgb_model = SklearnHelper(clf=RandomForestClassifier, seed=SEED, params=lgb_params)
